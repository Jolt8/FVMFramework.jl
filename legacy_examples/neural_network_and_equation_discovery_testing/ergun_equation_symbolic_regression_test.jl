...
# Format x_data as a matrix (features x datapoints)
...
# Run equation search with dimensional constraints
hall_of_fame = equation_search(
    x_matrix, y_data, niterations = 1000, options = options,
    parallelism = :serial,
    X_units = x_units, y_units = y_unit
)

# Print the best equations found
println(hall_of_fame)
