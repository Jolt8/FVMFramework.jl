...
def debug_twos_complement(tx=1, rx=2, vref=1.0, pre_trigger_offset_us=130.0, initial_target_tof_us=70.0, tolerance_pct=0.25, capture_time_us=400, sample_rate_hz=5_000_000):
    ...
    # Plot the signal
    plt.plot(time_us, volts, label='Signal (Two\'s Complement)', color='blue', alpha=0.7)
